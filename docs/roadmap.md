...
- la Unidad II quedó iniciada con `Tipos de datos para problemas biomédicos`, `Números, unidades y mediciones`, `Texto libre, códigos y vocabularios controlados`, `Booleanos, estados e incertidumbre`, `Fechas, tiempos, intervalos y granularidad clínica`, y `Ausencia de datos, valores centinela y marcadores especiales`;
- el siguiente bloque debe continuar con listas, diccionarios y registros.
