...
- Secciones publicables sobre números, unidades, mediciones, texto libre, códigos, vocabularios controlados, booleanos, estados e incertidumbre.
- Glosario vivo.
- Apéndice de entorno.
...
- continuar la segunda unidad con fechas, tiempos, intervalos y granularidad clínica;
- desarrollar ausencia, centinelas, listas, diccionarios y registros;
